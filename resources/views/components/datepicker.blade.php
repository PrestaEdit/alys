...
@php
$dpOptions = ['dateFormat' => 'DD/MM/YYYY'];
if ($value) {
...
<div
    ...
    x-init="
        $nextTick(() => {
            const wrapper = $el.querySelector('[data-hs-datepicker]');
            if (!wrapper) return;

            if (window.HSDatepicker) HSDatepicker.autoInit();

            wrapper.addEventListener('change.hs.datepicker', (e) => {
